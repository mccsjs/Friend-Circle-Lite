function initialize_fc_lite() {
    ...
    function processArticles(data) {
        ...
        statsContainer.innerHTML = `
            <div>项目来源: <a href="https://github.com/willow-god/Friend-Circle-Lite" target="_blank">FriendCircleLite</a><br></div>
            <div>使用者: <a href="https://seln.cn/" target="_blank">mccsjs</a><br></div>
